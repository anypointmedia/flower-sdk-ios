...
- (NSString *)changeChannelUrlFlowerAdsManager:(Sdk_coreFlowerAdsManagerImpl *)flowerAdsManager videoUrl:(NSString *)videoUrl adTagUrl:(NSString *)adTagUrl adUrlMacroValue:(Sdk_coreAdUrlMacroValue *)adUrlMacroValue extraParams:(NSDictionary<NSString *, id> * _Nullable)extraParams adTagHeaders:(NSDictionary<NSString *, NSString *> *)adTagHeaders channelStreamHeaders:(NSDictionary<NSString *, NSString *> *)channelStreamHeaders __attribute__((swift_name("changeChannelUrl(flowerAdsManager:videoUrl:adTagUrl:adUrlMacroValue:extraParams:adTagHeaders:channelStreamHeaders:)")));
- (void)destroy __attribute__((swift_name("destroy()")));
